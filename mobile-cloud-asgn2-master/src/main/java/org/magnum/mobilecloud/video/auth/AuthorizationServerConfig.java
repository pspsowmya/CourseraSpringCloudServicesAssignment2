...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	 ...
	 *
	 * This code is being provided solely for use in completing the assignment.
	 * Prior to implementing an authorization server, you should thoroughly read
	 * through the documentation and secure the server appropriately for your use
	 * case:
	 *
